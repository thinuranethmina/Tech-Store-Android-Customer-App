...
public class HomeCategoryAdapter extends RecyclerView.Adapter<HomeCategoryAdapter.ViewHolder> {
    ...
    public HomeCategoryAdapter(ArrayList<Category> categories, Context context, HomeCategorySelectListener selectListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.home_category_row_layout, parent, false);
